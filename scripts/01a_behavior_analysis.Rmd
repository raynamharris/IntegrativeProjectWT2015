...
behaviorsummaryNumAPA2$APA2 <- factor(behaviorsummaryNumAPA2$APA2, levels = c("yoked-consistent" ,"consistent", "yoked-conflict", "conflict"))

numentr <- ggplot(behaviorsummaryNumAPA2, 
