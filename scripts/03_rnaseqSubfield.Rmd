...
c <- DEGbargraph("DG", "standard.trained vs. conflict.trained", "standard trained vs.\nconflict trained")
h<- DEGbargraph("CA3", "standard.trained vs. conflict.trained", "standard trained vs.\nconflict trained")
m <- DEGbargraph("CA1", "standard.trained vs. conflict.trained", "standard trained vs.\nconflict trained")

d <- DEGbargraph("DG", "standard.yoked vs. conflict.yoked", "standard yoked vs.\nconflict yoked") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())
i <- DEGbargraph("CA3", "standard.yoked vs. conflict.yoked", "standard yoked vs.\nconflict yoked") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())
n <- DEGbargraph("CA1", "standard.yoked vs. conflict.yoked", "standard yoked vs.\nconflict yoked") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())

e <- DEGbargraph("DG", "yoked vs. trained", "yoked vs. trained") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())
j <- DEGbargraph("CA3", "yoked vs. trained", "yoked vs. trained") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())
o <- DEGbargraph("CA1", "yoked vs. trained", "yoked vs. trained") + theme(axis.title.y = element_blank(), axis.text.y = element_blank())

abcde <- plot_grid(a,b,c,d,e, nrow = 1)
fghij <- plot_grid(f,g,h,i,j, nrow = 1)
klmno <- plot_grid(k,l,m,n,o, nrow = 1)
...
plot_grid(abcde,fghij, klmno, ncol = 1)
