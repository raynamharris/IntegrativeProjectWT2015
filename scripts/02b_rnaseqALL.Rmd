...
plotCounts(dds, "GRM1", intgroup = "treatment", normalized = TRUE)
plotCounts(dds, "Grin2b", intgroup = "treatment", normalized = TRUE)
plotCounts(dds, "Foxj3", intgroup = "treatment", normalized = TRUE)
plotCounts(dds, "Grik3", intgroup = "treatment", normalized = TRUE)
plotCounts(dds, "Fos", intgroup = "treatment", normalized = TRUE)
plotCounts(dds, "Siah2", intgroup = "treatment", normalized = TRUE)
