...
combinePCvsd <- function(filename, whichsubfield){
...
vsdDG <- combinePCvsd("../data/03_DG_vsdtraining.csv", "DG")
vsdCA1 <- combinePCvsd("../data/03_CA3_vsdtraining.csv", "CA1")
vsdCA3 <- combinePCvsd("../data/03_DG_vsdtraining.csv", "CA3")
...
# gene gene ames
genenames <- data.frame(names(vsdDG[9:17002]))
genenames
```
