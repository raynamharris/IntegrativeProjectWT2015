...
This top 10 gene list for how the DG tissue responds to treatment is very different from the top 10 list above that showed genes in all three tissues that responded significantly to the behavioral treatment. 
