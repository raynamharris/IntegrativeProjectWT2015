...
![](../figures/02c_rnaseqSubfield/totalDEGs-1.png)
    ...
    write.csv(all, file = paste("../data/02c_",i,"forupset.csv", sep = ""))
    }
...
![](../figures/02c_rnaseqSubfield/upsetplot-1.png)
    ...
    upset(myupsetdf, keep.order = T,
          sets = c( "CA1-conf-yconf","CA1-cons-ycons", "CA1-yconf-ycons",
                    "CA3-cons-ycons", "CA3-yconf-ycons",
                    "DG-conf-cons", "DG-conf-yconf", "DG-cons-ycons","DG-yconf-ycons"
                    )
          )
...
![](../figures/02c_rnaseqSubfield/upsetplot-2.png)
    ...
    upset(myupsetdf, keep.order = T,
          sets = c("CA1-yconf-ycons", "CA1-cons-ycons", "DG-cons-ycons"),
          sets.bar.color=c("#7570b3","#7570b3", "#d95f02")
    )
...
![](../figures/02c_rnaseqSubfield/upsetplot-3.png)
    ...
    upset(myupsetdf, keep.order = T,
          sets = c("CA1-yconf-ycons", "CA1-cons-ycons", "DG-cons-ycons"),
          sets.bar.color=c("#7570b3","#7570b3", "#d95f02"),
          queries = list(list(query = intersects, params = list("CA1-cons-ycons"), color = "#ca0020", active = T),
                         list(query = intersects, params = list("DG-cons-ycons"), color = "#ca0020", active = T),
                         list(query = intersects, params = list("CA1-cons-ycons", "DG-cons-ycons"), color = "#ca0020", active = T))
    )
