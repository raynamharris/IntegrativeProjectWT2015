...
---------------------------------
    ...
    GO_DNArepair <- read.table("../data/goterms/GO_term_summary_20200130_140500.txt", sep = "\t", row.names = NULL,  fill=TRUE)
    GO_DNArepair$GO <- "5. DNA repair (GO:0006281)" 

    GO_signaltransduction <- read.table("../data/goterms/GO_term_summary_20200130_140705.txt", sep = "\t", row.names = NULL,  fill=TRUE)
    ...
    GO_heterocyclebiosyntheticprocess <- read.table("../data/goterms/GO_term_summary_20200130_140958.txt", sep = "\t", row.names = NULL,  fill=TRUE)
    GO_heterocyclebiosyntheticprocess$GO <- "7. Heterocycle biosynthetic process (GO:0018130)" 


    GO_glucosetransmembranetransport <- read.table("../data/goterms/GO_term_summary_20200130_141051.txt", sep = "\t", row.names = NULL,  fill=TRUE)
