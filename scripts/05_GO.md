...
![](../figures/05_GO/Screen%20Shot%202020-01-30%20at%2011.19.35%20AM.png)
    ...
    ## 5                       05_DNArepair.txt      5
    ## 6              06_signaltransduction.txt      6
    ## 7  07_heterocyclebiosyntheticprocess.txt      7
    ## 8   08_glucosetransmembranetransport.txt      8
    ## 9               09_negregcellprocess.txt      9
    ## 10               10_regcellmacbiosyn.txt     10
    ## 11                   11_regmacbiosyn.txt     11
    ## 12             12_cellresponchemstim.txt     12
    ...
    ## 5 05_DNArepair       Bach1, Hspa1a, Mc1r                                   
    ## 6 06_signaltransduc… Abhd2, Adrb1, Ahr, Apaf1, Arc, Arid5b, Arl13b, Atf3, …
    ...
    ##    GO                                significantgenes
    ##    <chr>                                        <int>
    ##  1 01_responsetostimulus                          461
    ##  2 02_translation                                   5
    ##  3 03_synapseorganization                          18
    ##  4 04_learningormemory                             25
    ##  5 05_DNArepair                                     3
    ##  6 06_signaltransduction                          229
    ##  7 07_heterocyclebiosyntheticprocess              117
    ##  8 08_glucosetransmembranetransport                 7
    ##  9 09_negregcellprocess                           169
    ## 10 10_regcellmacbiosyn                            111
    ## 11 11_regmacbiosyn                                112
    ## 12 12_cellresponchemstim                          142
    ...
    ## # A tibble: 12 x 6
    ##    category  GO        totalgenes significantgenes percent higerthanmeanen…
    ##    <chr>     <chr>          <int>            <int>   <dbl> <chr>           
    ##  1 hypothes… 01_respo…      26179              461   1.76  no              
    ##  2 hypothes… 02_trans…        233                5   2.15  no              
    ##  3 hypothes… 03_synap…       1129               18   1.59  no              
    ##  4 hypothes… 04_learn…        501               25   4.99  yes             
    ##  5 random    05_DNAre…       1019                3   0.290 no              
    ##  6 random    06_signa…      13325              229   1.72  no              
    ##  7 random    07_heter…       4108              117   2.85  yes             
    ##  8 random    08_gluco…        159                7   4.4   yes             
    ##  9 enriched  09_negre…       6630              169   2.55  yes             
    ## 10 enriched  10_regce…       4496              111   2.47  yes             
    ## 11 enriched  11_regma…       4663              112   2.4   no              
    ## 12 enriched  12_cellr…       5822              142   2.44  no
