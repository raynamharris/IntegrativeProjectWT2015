...
behav <- behav %>%
  ...
  mutate(TrainSessionCombo = fct_collapse(TrainSession,
                                      "T4_C1" = c("T4", "C1"),
                                      "T5_C2" = c("T5", "C2"),
                                      "T6_C3" = c("T6", "C3"),
                                      "Hab"  = "Hab",
...
behav$TrainSessionComboNum <- as.numeric(behav$TrainSessionCombo)

behav <- behav %>%  dplyr::select(ID,Day,treatment, training,TrainSessionCombo,
                                 TrainSessionComboNum, ShockOnOff, PairedPartner,
