...
res_summary_subfield(c("treatment", "standard.trained", "standard.yoked"))
res_summary_subfield(c("treatment", "conflict.trained", "conflict.yoked"))
res_summary_subfield(c("treatment", "conflict.trained", "standard.trained"))
res_summary_subfield(c("treatment", "conflict.yoked", "standard.yoked"))
```
