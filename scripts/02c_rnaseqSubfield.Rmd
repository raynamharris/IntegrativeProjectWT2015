...
```{r twowaycontrasts}
print("DG")
res_summary_subfield(DGdds, c("treatment", "standard.trained", "standard.yoked"))
res_summary_subfield(DGdds, c("treatment", "conflict.trained", "conflict.yoked"))
...
print("CA3")
res_summary_subfield(CA3dds, c("treatment", "standard.trained", "standard.yoked"))
res_summary_subfield(CA3dds, c("treatment", "conflict.trained", "conflict.yoked"))
...
print("CA1")
res_summary_subfield(CA1dds, c("treatment", "standard.trained", "standard.yoked"))
res_summary_subfield(CA1dds, c("treatment", "conflict.trained", "conflict.yoked"))
...
DGconsyokcons <-  plot.volcano(DGdds, "treatment", "standard.trained", "standard.yoked", volcano1, "DG") 
DGconflicttrained <-  plot.volcano(DGdds, "treatment", "conflict.trained", "conflict.yoked", volcano5, "DG") 
DGtrained <- plot.volcano(DGdds2, "combinedgroups", "trained", "yoked", volcano7, "DG") 

CA1consyokcons <-  plot.volcano(CA1dds, "treatment", "standard.trained", "standard.yoked", volcano1,  "CA1")  
CA1yoked <-  plot.volcano(CA1dds, "treatment","conflict.yoked", "standard.yoked", volcano6,  "CA1") 
