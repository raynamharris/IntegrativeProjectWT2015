...
b <- onebehaviornolegend(data=behavior, xcol="TrainSessionComboNum", ycol="Path2ndEntr",
             yaxislabel="Path to 2nd Entrance (m)", colorcode="APA")
...
e <- onebehaviornolegend(data=behavior, xcol="TrainSessionComboNum", ycol="NumEntrances",
             yaxislabel="Number of Shock Zone Entrances", colorcode="APA")
f <- onebehavior(data=behavior, xcol="TrainSessionComboNum", ycol="pTimeCW",
             yaxislabel="% Time Clockwise \nof the Shock Zone", colorcode="APA")

plot_grid(a,b,c,d,e,f,nrow=2, rel_widths=c(1,1,1.75,1,1,1.75))


g <- onebehaviornolegend(data=behavior, xcol="TrainSessionComboNum", 
             ycol="TotalPathArena.m", yaxislabel="Total Path (m)", colorcode="APA")
h <- onebehaviornolegend(data=behavior, xcol="TrainSessionComboNum", ycol="SpeedArena.cm.s",
             yaxislabel="Average Speed (cm/s)", colorcode="APA")
i <- onebehaviornolegend(data=behavior, xcol="TrainSessionComboNum", ycol="SpeedArena.cm.s",
             yaxislabel="Average Speed (cm/s)", colorcode="APA")
plot_grid(g,h,i, nrow=1, rel_widths=c(1,1,1.75))
```
