...
plotPCelipse <- function(df, xcol, ycol, aescolor, colorname, colorvalues){
  ggplot(df, aes(df[xcol], df[ycol], color=aescolor)) +
    ...
    stat_ellipse(level = 0.95, color = avoidance, (aes(color=colorvalavoidance)),size=0.25) + 
...
PCA12 <- plotPCelipse(pcadata, 1, 2, aescolor = pcadata$avoidance, colorname = " ",  colorvalues = colorvalavoidance)
