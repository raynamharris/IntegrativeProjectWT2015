...
myhistogram(contrastvector = c("Punch", "DG", "CA1"), mypval = 0.05)
myhistogram(contrastvector = c("Punch", "CA3", "CA1"), mypval = 0.05)
myhistogram(contrastvector = c("Punch", "DG", "CA3"), mypval = 0.05)
myhistogram(contrastvector = c("APA", "Same", "Yoked"), mypval = 0.05)
myhistogram(contrastvector = c("APA", "Conflict", "Yoked"), mypval = 0.05)
myhistogram(contrastvector = c("APA", "Conflict", "Same"), mypval = 0.05)
