...
pdf(file="../figures/02b_RNAseqConsistent/PCA12.pdf", width=1.75, height=2.25)
plot(PCA12)
dev.off()

pdf(file="../figures/02b_RNAseqConsistent/PCA42.pdf", width=1.75, height=2.25)
plot(PCA42)
dev.off()
...
# gene lists
res <- results(dds, contrast =c("Punch", "CA1", "DG"), independentFiltering = T, alpha = 0.05, cooksCutoff = F)
summary(res)
resOrdered <- res[order(res$padj),]
head(resOrdered, 10)
data <- data.frame(gene = row.names(res), pvalue = (res$padj ), lfc = res$log2FoldChange, mean = res$baseMean)

head(data[data$mean == NA,])
...
pdf(file="../figures/02b_RNAseqConsistent/AllCA1DG.pdf", width=1.25, height=1.75)
plot(colored)
dev.off()
...
colored
pdf(file="../figures/02b_RNAseqConsistent/AllCA1CA3.pdf", width=1.25, height=1.75)
plot(colored)
dev.off()
...
pdf(file="../figures/02b_RNAseqConsistent/AllDGCA3.pdf", width=1.25, height=1.75)
plot(colored)
dev.off()
