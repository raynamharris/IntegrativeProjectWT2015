...
r1 <- ggdraw() + draw_image(CA1conflictconsistent) # turn png into ggplot object
r2 <- ggdraw() + draw_image(CA1consistentyoked) # turn png into ggplot object
r3 <- ggdraw() + draw_image(CA1yokedyoked) # turn png into ggplot object
p1 <- ggdraw() + draw_image(CA3conflictconsistent) # turn png into ggplot object
p2 <- ggdraw() + draw_image(CA3consistentyoked) # turn png into ggplot object
p3 <- ggdraw() + draw_image(CA3yokedyoked) # turn png into ggplot object
q1 <- ggdraw() + draw_image(DGconflictconsistent) # turn png into ggplot object
q2 <- ggdraw() + draw_image(DGconsistentyoked) # turn png into ggplot object
q3 <- ggdraw() + draw_image(DGyokedyoked) # turn png into ggplot object

plot_grid(q2, p2, r2, nrow=2) #consistent
plot_grid(q1, p1, r1, nrow=2) #conflcit
plot_grid(q3, p3, r3, nrow=2) #yoked

plot_grid(r1, r2, r3, nrow=2) #CA1
plot_grid(p1, p2, p3, nrow=2) #CA3
plot_grid(q1, q2, q3, nrow=2) #DG
