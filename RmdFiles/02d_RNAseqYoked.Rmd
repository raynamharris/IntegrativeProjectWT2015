---
title: "02c_rnaseq_yoked_consistentyoked_conflict"
...
Behavioral Groups: "yoked_consistent", "yoked_conflict"
...
pheatmap(DEGes, show_colnames=F, show_rownames = F,
         ...
         breaks=myBreaks,
         clustering_distance_cols="correlation",
         filename = "../figures/02d_RNAseqYoked/pheatmap.pdf"
         )
...
pheatmap(DEGes, show_colnames=F, show_rownames = F,
         ...
         breaks=myBreaks,
         clustering_distance_cols="correlation", 
         filename = "../figures/02d_RNAseqYoked/pheatmap_minimal.pdf"
         )
```
...
pdf(file="../figures/02d_RNAseqYoked/AllCA1DG.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
colored <- ggplot(data, aes(x = lfc, y = pvalue)) + 
  ...
  geom_hline(yintercept = 1.3,  size = 0.25, linetype = 2 ) 
colored
pdf(file="../figures/02d_RNAseqYoked/AllCA1CA3.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
colored
#cvd_grid(colored)
pdf(file="../figures/02d_RNAseqYoked/AllDGCA3.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02d_RNAseqYoked/Allyoked_consistentyoked_conflict.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02d_RNAseqYoked/DGyoked_consistentyoked_conflict.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
pdf(file="../figures/02d_RNAseqYoked/CA3yoked_consistentyoked_conflict.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
sign[res$log2FoldChange<0]=-1  
logs$logP <- logs$logP*sign
write.csv(logs, file = "./02e_GO_MWU/CAyokedyoked.csv", row.names = F)
...
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02d_RNAseqYoked/CA1yoked_consistentyoked_conflict.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
sign[res$log2FoldChange<0]=-1  
logs$logP <- logs$logP*sign
write.csv(logs, file = "./02e_GO_MWU/CA1yokedyoked.csv", row.names = F)
