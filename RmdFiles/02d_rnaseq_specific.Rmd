...
knitr::opts_chunk$set(fig.path = '../figures/02_RNAseq_subsets/')
```



## recreating previous figure
Consistent and yoke consistent animals only

```{r ConsistentYokedonly}
...
pdf(file="../figures/02_RNAseq_subsets/ConsistentDGCA1.pdf", width=3, height=3)
plot(colored)
dev.off()
...
pdf(file="../figures/02_RNAseq_subsets/consistentyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
dds <- DESeq(dds)
dds$Punch <- factor(dds$Punch, levels=c("DG", "CA3", "CA1"))
dds$APA2 <- factor(dds$APA2, levels=c("yoked_conflict",  "conflict")) ## specify the factor levels
...
pdf(file="../figures/02_RNAseq_subsets/ConflictDGCA1.pdf", width=3, height=3)
plot(colored)
dev.off()
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_subsets/conflictyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_subsets/CA1consistentyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_subsets/DGconsistentyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_subsets/DGconflictyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
dds$APA <- factor(dds$APA, levels=c("Consistent", "Control")) ## specify the factor levels
...
pdf(file="../figures/02_RNAseq_subsets/DGConsistentControl.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
pdf(file="../figures/02_RNAseq_subsets/DGConflictControl.pdf", width=3, height=3)
plot(colored)
dev.off()
...
pdf(file="../figures/02_RNAseq_subsets/ControlDGCA1.pdf", width=3, height=3)
plot(colored)
dev.off()
...
pdf(file="../figures/02_RNAseq_subsets/ControlDGCA3.pdf", width=3, height=3)
plot(colored)
dev.off()
...
pdf(file="../figures/02_RNAseq_subsets/ConsistentDGCA3.pdf", width=3, height=3)
plot(colored)
dev.off()
```
