...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_4by3/CA1consistentyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_4by3/DGconsistentyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
...
colored
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02_RNAseq_4by3/DGconflictyoked.pdf", width=3, height=3)
plot(colored)
dev.off()
```
