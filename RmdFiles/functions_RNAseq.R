...
plotPC2PC5 <- function(aescolor, colorname, aesshape, shapename, colorvalues){
  ggplot(pcadata, aes(PC2, PC5, color=aescolor, shape=aesshape)) +
    geom_point(size=5) +
    xlab(paste0("PC2: ",percentVar[2],"% variance")) +
...
plotPC2PC6 <- function(aescolor, colorname, aesshape, shapename, colorvalues){
  ggplot(pcadata, aes(PC2, PC6, color=aescolor, shape=aesshape)) +
    geom_point(size=5) +
    xlab(paste0("PC2: ",percentVar[2],"% variance")) +
