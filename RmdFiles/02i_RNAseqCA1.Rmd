...
pdf(file="../figures/02i_RNAseqCA1/consistent.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
pdf(file="../figures/02i_RNAseqCA1/confict.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
#cvd_grid(colored) # to view plot for color blind 
pdf(file="../figures/02i_RNAseqCA1/yoked.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
...
res <- results(dds, contrast =c("APA2", "conflict", "yoked_consistent"), independentFiltering = T, alpha = 0.05)
summary(res)
```
