...
MF_CA1conflictconsistent <- read.csv("MF_CA1conflictconsistent.csv", sep="\t", header = T)
MF_CA3conflictconsistent <- read.csv("MF_CA3conflictconsistent.csv", sep="\t", header = T)
