...
```{r DGconsistentyoked, warning=F, message=F}
# input files
...
```{r CA3consistentyoked, warning=F, message=F}
# input files
...
```{r CA1consistentyoked, warning=F, message=F}
# input files
...
```{r DGconflictconsistent, warning=F}
# input files
...
```{r CA3conflictconsistent, warning=F}
...
```{r CA1conflictconsistent, warning=F}
# input files
