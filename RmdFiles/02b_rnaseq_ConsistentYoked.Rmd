---
title: "02b_rnaseq_ConsistentYoked"
...
colored <- ggplot(data, aes(x = lfc, y = pvalue)) + 
  ...
  scale_y_continuous(name="-log10 (adjusted p-value",
                    limits= c(0, 12.5)) +
  draw_image(imgDG, scale = 5, x=-3, y=10.75)
...
colored <- ggplot(data, aes(x = lfc, y = pvalue)) + 
  ...
  scale_y_continuous(name="-log10 (adjusted p-value",
                    limits= c(0, 12.5)) +
  draw_image(imgCA3, scale = 5, x=-3, y=10.75)
...
colored <- ggplot(data, aes(x = lfc, y = pvalue)) + 
  ...
  scale_y_continuous(name="-log10 (adjusted p-value",
                    limits= c(0, 12.5))  +  
  draw_image(imgCA1, scale = 5, x=-3, y=10.5)
