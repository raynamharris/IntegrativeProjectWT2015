...
DEGes$padjmin <- with(DEGes, pmin(padjPunchCA1DG, padjPunchCA1CA3, padjPunchCA3DG, padjAPA3Yoked_NoConflictAPA3Yoked_Conflict, padjAPA3Trained_ConflictTrained_NoConflict)) # create new col with min padj
